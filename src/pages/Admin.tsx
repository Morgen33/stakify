          ...
          <TabsContent value="fees" className="space-y-6">
            ...
            <div className="rounded-lg border border-neon-green/30 bg-neon-green/5 p-5 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground/80 mt-1">Manage platform fees, per-project rates, and view the fee structure. The <strong className="text-neon-green">Master Network Fee ($0.12/action)</strong> can only be changed by the Master. All other fees are subject to change.</p>
              </div>
            </div>
